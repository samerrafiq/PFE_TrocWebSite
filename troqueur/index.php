...
<body>
    ...
    <section class="main-section">
        ...
        $result = mysqli_query($code, "SELECT * FROM annonce WHERE titre LIKE '%$keywords%' AND code_cat LIKE '%$categorie%'");
        ...
        $result = mysqli_query($code, "SELECT code_anc, titre, image_1, date_pub FROM annonce WHERE titre LIKE '%$keywords%' AND code_cat LIKE '%$categorie%' LIMIT $starting_limit_number, $result_per_page");
        for($i = 1; $i <= 20; ++$i)
        {
        ?>
            <div class="cards">
        <?php
            for($index = 1; $annonce = mysqli_fetch_assoc($result) and $index <= 5; ++$index)
            {
        ...
        ?>
                <div class="card">
                    ...
                    <a href="index.php?favoris=<?php print($code_anc);?>"><img class="favorite" src="../images/Site-Web/favorite-off.png" height="20px" width="20px" id="<?php print($code_anc);?>"></a>
                    <?php
        ...
        <div class="page-index">
            ...
            if($result_per_page > 100)
            {
                ...
                {
            ?>
                    <a href="index.php?page=<?php print($page);?>"><Button class="<?php echo $page;?>"><?php print($page);?></Button></a>
            <?php
                }
            }
            ?>
